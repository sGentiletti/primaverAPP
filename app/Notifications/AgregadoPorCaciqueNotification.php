...
class AgregadoPorCaciqueNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('Bienvenid@ ' . $this->name . '. Verifica tu correo')
            ->line('Bienvenid@ a la plataforma virtual de la SEJU. Te han agregado a una tribu. ¡Que emoción! Para confirmar tu registro, debés verificar tu cuenta haciendo click en el botón.')
